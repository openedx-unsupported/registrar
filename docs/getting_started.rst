...
Configuring Registrar to communicate with other IDAs using OAuth requires registering a new client with the authentication
...
A new OAuth 2.0 client can be created when using Devstack by visiting ``http://127.0.0.1:18000/admin/oauth2_provider/application/``.
    ...
    3. Specify the name of this service, ``registrar``, as the client name.
