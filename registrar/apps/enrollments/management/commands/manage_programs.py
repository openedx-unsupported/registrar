...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "uuidkeys",
            help=(
                "specify the programs to create or modify, in a single comma "
    ...
    def get_authoring_org_keys(self, program_dict):
        ...
        if not org_keys:
            raise CommandError(
                "No authoring org keys found for program {}".format(
    ...
    def get_org(self, org_keys):
        ...
        raise CommandError(
            "None of the authoring organizations {} were found in Registrar".format(
                org_keys
            )
        )
    ...
    def create_or_modify_program(self, org, program_dict, program_uuid, program_key):
        ...
        logger.info(
            "{} program (key={} uuid={} managing_org={})".format(
