...
urlpatterns = [
    ...
    url(
        r"^programs/{}/courses/{}/grades/?$".format(
            PROGRAM_KEY_PATTERN, COURSE_ID_PATTERN
        ),
        views.CourseGradesView.as_view(),
        name="program-course-grades",
    ),
    url(
        r"^programs/{}/courses/{}/enrollments/?$".format(
            PROGRAM_KEY_PATTERN, COURSE_ID_PATTERN
        ),
    ...
    url(
        r"^programs/{}/reports".format(PROGRAM_KEY_PATTERN),
        views.ReportsListView.as_view(),
    ),
    url(r"^jobs/?$", views.JobStatusListView.as_view(), name="job-status-list"),
    url(
